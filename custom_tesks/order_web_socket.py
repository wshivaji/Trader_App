...
class order_web_socket:
    ...
    def __init__(self):
        ...
        self.fyers = order_ws.FyersOrderSocket(
            ...
            log_path="",
            # The path to the log file if write_to_file is set to True (empty string means current directory).
    ...
    def start_order_web_socket(self):
        try:
    ...
    def onopen(self):
        ...
        # data_type = "OnGeneral"
        self.data_type = "OnOrders,OnTrades,OnPositions,OnGeneral"

        self.fyers.subscribe(data_type=self.data_type)

        # Keep the socket running to receive real-time data
        self.fyers.keep_running()


order_web_socket().start_order_web_socket()
